...
def calculate_max_message_size(image):
    ...
    # Assuming 3 color channels (RGB) and 1 bit per channel for LSB
...
# Step 4: Next Steps
action = input("Would you like to (E) Embed a message or (R) Retrieve a message? ").strip().upper()
...
# Step 5: Delete the original image...
